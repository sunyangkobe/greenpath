...
<?php if ($this->getParam('logo_type')=='image') { ?>
	<a id="logo" style="width:<?php echo $this->getParam('logo_width') ?>px;height:<?php echo $this->getParam('logo_height') ?>px" href="<?php echo "http://www.utsc.utoronto.ca"?>"></a>
	<a id="gp-logo" style="width:720px;height:149px" href="<?php echo $this->baseUrl?>"></a>
<?php } else { ?>
